...
public class ItemFrameEntity {
    ...
    public static boolean DEFAULT_FIXED;
    public static float DEFAULT_FRICTION;
    public static boolean DEFAULT_INVISIBLE;
    public static float DEFAULT_ITEM_DROP_CHANCE;
    public static byte DEFAULT_ITEM_ROTATION;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<murat.simv2.simulation.mirror.net.minecraft.item.ItemStack> ITEM_STACK;
    ...
    public static java.util.function.Predicate<murat.simv2.simulation.mirror.net.minecraft.entity.Entity> PREDICATE;
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Integer> ROTATION;
    public static java.lang.String UUID_KEY;
    public int age;
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos attachedBlockPos;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.Direction facing;
    public double fallDistance;
    public static int field_30454;
    ...
    public static float field_51592;
    public static float field_51593;
    public static float field_51594;
    ...
    public ItemFrameEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }

    public ItemFrameEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p2, murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p3) {
    }

    public ItemFrameEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1, murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p2) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.Box calculateBoundingBox(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p1) {
        return null;
    }
    ...
    public static boolean canDamageWhenFixed(murat.simv2.simulation.mirror.net.minecraft.entity.damage.DamageSource p0) {
        return false;
    }
    ...
    public void dropHeldStack(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.entity.Entity p1, boolean p2) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getAddItemSound() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.item.ItemStack getAsItemStack() {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos getAttachedBlockPos() {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.util.math.Box getAttachmentBox() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.item.ItemStack getHeldItemStack() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.component.type.MapIdComponent getMapId(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getRemoveItemSound() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getRotateItemSound() {
        return null;
    }
    ...
    public void onBreak(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.entity.Entity p1) {
    }
    ...
    public void removeFromFrame(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
    }
    ...
    public void setAsStackHolder(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
    }
    ...
    public void setFacing(murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p0) {
    }
    ...
    public void setHeldItemStack(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
    }

    public void setHeldItemStack(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, boolean p1) {
    }
    ...
    public void setRotation(int p0, boolean p1) {
    }
    ...
    public boolean shouldDropHeldStackWhenDamaged(murat.simv2.simulation.mirror.net.minecraft.entity.damage.DamageSource p0) {
        return false;
    }
