...
public class TameableShoulderEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.passive.TameableEntity {
    ...
    public static int READY_TO_SIT_COOLDOWN;
    ...
    public TameableShoulderEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
