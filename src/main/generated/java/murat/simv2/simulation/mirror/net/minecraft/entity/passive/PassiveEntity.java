...
public class PassiveEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.mob.PathAwareEntity {
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Boolean> CHILD;
    ...
    public PassiveEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public static class PassiveData extends java.lang.Object implements murat.simv2.simulation.mirror.net.minecraft.entity.EntityData {
        public boolean babyAllowed;
        public float babyChance;
        public int spawnCount;

        public PassiveData(boolean p0) {
        }

        public PassiveData(boolean p0, float p1) {
        }

        public PassiveData(float p0) {
        }
