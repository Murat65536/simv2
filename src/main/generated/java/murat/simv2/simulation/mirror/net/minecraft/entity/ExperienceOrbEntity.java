...
public class ExperienceOrbEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.Entity {
    ...
    public static int MERGING_CHANCE_FRACTION;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Integer> VALUE;
    public int age;
    ...
    public static int field_30057;
    public static double field_30059;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity target;
    ...
    public ExperienceOrbEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }

    public ExperienceOrbEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, double p1, double p2, double p3, int p4) {
    }
    ...
    public void applyWaterMovement() {
    }
    ...
    public boolean isMergeable(murat.simv2.simulation.mirror.net.minecraft.entity.ExperienceOrbEntity p0) {
        return false;
    }

    public static boolean isMergeable(murat.simv2.simulation.mirror.net.minecraft.entity.ExperienceOrbEntity p0, int p1, int p2) {
        return false;
    }
    ...
    public void merge(murat.simv2.simulation.mirror.net.minecraft.entity.ExperienceOrbEntity p0) {
    }
    ...
    public int repairPlayerGears(murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity p0, int p1) {
        return 0;
    }
    ...
    public static int roundToOrbSize(int p0) {
        return 0;
    }
    ...
    public static void spawn(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p1, int p2) {
    }
    ...
    public static boolean wasMergedIntoExistingOrb(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p1, int p2) {
        return false;
    }
