...
public class ItemEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.Entity implements murat.simv2.simulation.mirror.net.minecraft.entity.Ownable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static int CANNOT_PICK_UP_DELAY;
    public static short DEFAULT_AGE;
    public static float DEFAULT_FRICTION;
    public static int DEFAULT_HEALTH;
    public static int DEFAULT_MIN_FREEZE_DAMAGE_TICKS;
    public static short DEFAULT_PICKUP_DELAY;
    public static int DEFAULT_PORTAL_COOLDOWN;
    public static int DESPAWN_AGE;
    ...
    public static int NEVER_DESPAWN_AGE;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<murat.simv2.simulation.mirror.net.minecraft.item.ItemStack> STACK;
    ...
    public static float field_48702;
    public static float field_48703;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.Entity thrower;
    public java.util.UUID throwerUuid;
    ...
    public ItemEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }

    public ItemEntity(murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity p0) {
    }

    public ItemEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, double p1, double p2, double p3, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p4) {
    }

    public ItemEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, double p1, double p2, double p3, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p4, double p5, double p6, double p7) {
    }
    ...
    public void applyBuoyancy(double p0) {
    }

    public void applyGravity() {
    }

    public void applyLavaBuoyancy() {
    }
    ...
    public static boolean canMerge(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1) {
        return false;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity copy() {
        return null;
    }
    ...
    public static float getRotation(float p0, float p1) {
        return 0.0F;
    }
    ...
    public static void merge(murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity p2, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p3) {
    }

    public static void merge(murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p2) {
    }

    public static murat.simv2.simulation.mirror.net.minecraft.item.ItemStack merge(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, int p2) {
        return null;
    }
    ...
    public void setPickupDelay(int p0) {
    }
    ...
    public void setThrower(murat.simv2.simulation.mirror.net.minecraft.entity.Entity p0) {
    }
    ...
    public void tryMerge(murat.simv2.simulation.mirror.net.minecraft.entity.ItemEntity p0) {
    }
