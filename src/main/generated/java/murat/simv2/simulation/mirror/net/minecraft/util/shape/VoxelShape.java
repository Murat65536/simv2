...
public class VoxelShape {
    ...
    public VoxelShape(murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelSet p0) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape getUncachedFace(murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p0) {
        return null;
    }
    ...
    public boolean isSquare(murat.simv2.simulation.mirror.net.minecraft.util.math.Direction.Axis p0) {
        return false;
    }
