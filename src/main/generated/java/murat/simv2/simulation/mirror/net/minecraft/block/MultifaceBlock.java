...
public class MultifaceBlock extends murat.simv2.simulation.mirror.net.minecraft.block.Block implements murat.simv2.simulation.mirror.net.minecraft.block.Waterloggable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.block.MultifaceBlock> CODEC;
    public static murat.simv2.simulation.mirror.net.minecraft.util.math.Direction[] DIRECTIONS;
    public static java.util.Map<murat.simv2.simulation.mirror.net.minecraft.util.math.Direction, murat.simv2.simulation.mirror.net.minecraft.state.property.BooleanProperty> FACING_PROPERTIES;
    ...
    public boolean hasAllHorizontalDirections;
    ...
    public java.util.function.Function<murat.simv2.simulation.mirror.net.minecraft.block.BlockState, murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape> shapeFunction;
    ...
    public MultifaceBlock(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
    ...
    public java.util.function.Function createShapeFunction() {
        return null;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.block.BlockState disableDirection(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0, murat.simv2.simulation.mirror.net.minecraft.state.property.BooleanProperty p1) {
        return null;
    }
    ...
    public static boolean isNotFullBlock(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.block.BlockState mirror(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0, java.util.function.Function p1) {
        return null;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.block.BlockState withAllDirections(murat.simv2.simulation.mirror.net.minecraft.state.StateManager p0) {
        return null;
    }
