...
public class BlockEntity extends java.lang.Object {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static org.slf4j.Logger LOGGER;
    public static com.mojang.serialization.Codec<murat.simv2.simulation.mirror.net.minecraft.block.entity.BlockEntityType<?>> TYPE_CODEC;
    public murat.simv2.simulation.mirror.net.minecraft.block.BlockState cachedState;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.block.entity.BlockEntityType<?> type;
    public murat.simv2.simulation.mirror.net.minecraft.world.World world;

    public BlockEntity(murat.simv2.simulation.mirror.net.minecraft.block.entity.BlockEntityType p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1, murat.simv2.simulation.mirror.net.minecraft.block.BlockState p2) {
    }
    ...
    public java.lang.String getNameForReport() {
        return null;
    }
    ...
    public void validateSupports(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
    }

    public void writeIdToNbt(murat.simv2.simulation.mirror.net.minecraft.nbt.NbtCompound p0) {
    }
    ...
    public void writeIdentifyingData(murat.simv2.simulation.mirror.net.minecraft.nbt.NbtCompound p0) {
    }
    ...
    public static class Components extends java.lang.Object {
        public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.component.ComponentMap> CODEC;
