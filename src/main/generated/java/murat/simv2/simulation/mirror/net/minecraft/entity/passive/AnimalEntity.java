...
public class AnimalEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.passive.PassiveEntity {
    ...
    public static int DEFAULT_LOVE_TICKS;
    ...
    public java.util.UUID lovingPlayer;
    ...
    public AnimalEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
