...
public class Block extends murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock implements murat.simv2.simulation.mirror.net.minecraft.item.ItemConvertible {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.block.Block> CODEC;
    public static murat.simv2.simulation.mirror.net.minecraft.util.math.Direction[] DIRECTIONS;
    public static java.lang.ThreadLocal<it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap<murat.simv2.simulation.mirror.net.minecraft.block.Block.VoxelShapePair>> FACE_CULL_MAP;
    public static int FACE_CULL_MAP_SIZE;
    public static int FORCE_STATE;
    public static int FORCE_STATE_AND_SKIP_CALLBACKS_AND_DROPS;
    public static com.google.common.cache.LoadingCache<murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape, java.lang.Boolean> FULL_CUBE_SHAPE_CACHE;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.item.Item cachedItem;
    public boolean collidable;
    public murat.simv2.simulation.mirror.net.minecraft.block.BlockState defaultState;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry.Reference<murat.simv2.simulation.mirror.net.minecraft.block.Block> registryEntry;
    ...
    public Block(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.state.State applyValueToState(murat.simv2.simulation.mirror.net.minecraft.state.State p0, murat.simv2.simulation.mirror.net.minecraft.state.property.Property p1, java.lang.Object p2) {
        return null;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.block.BlockState copyProperty(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0, murat.simv2.simulation.mirror.net.minecraft.block.BlockState p1, murat.simv2.simulation.mirror.net.minecraft.state.property.Property p2) {
        return null;
    }
    ...
    public static void dropStack(murat.simv2.simulation.mirror.net.minecraft.world.World p0, java.util.function.Supplier p1, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p2) {
    }
    ...
    public static class VoxelShapePair {
        public murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape first;
        public murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape second;

        public VoxelShapePair(murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape p0, murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape p1) {
        }
