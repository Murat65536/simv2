...
public class ExperimentalMinecartShapeContext extends murat.simv2.simulation.mirror.net.minecraft.block.EntityShapeContext {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static murat.simv2.simulation.mirror.net.minecraft.block.ShapeContext ABSENT;
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos ascendingPos;
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos belowPos;

    public ExperimentalMinecartShapeContext(murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractMinecartEntity p0, boolean p1) {
    }
    ...
    public void setIgnoredPositions(murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractMinecartEntity p0) {
    }

    public ExperimentalMinecartShapeContext() {
    }
