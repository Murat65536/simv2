...
public class SimpleVoxelShape extends murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelSet voxels;

    public SimpleVoxelShape(murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelSet p0) {
    }
