...
public class HostileEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.mob.PathAwareEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.mob.Monster {
    ...
    public HostileEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
