...
public class LadderBlock extends murat.simv2.simulation.mirror.net.minecraft.block.Block implements murat.simv2.simulation.mirror.net.minecraft.block.Waterloggable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.block.LadderBlock> CODEC;
    ...
    public static java.util.Map<murat.simv2.simulation.mirror.net.minecraft.util.math.Direction, murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape> SHAPES_BY_DIRECTION;
    ...
    public LadderBlock(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
    ...
    public boolean canPlaceOn(murat.simv2.simulation.mirror.net.minecraft.world.BlockView p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1, murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p2) {
        return false;
    }
