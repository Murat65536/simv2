...
public class MobEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentHolder, murat.simv2.simulation.mirror.net.minecraft.entity.Leashable, murat.simv2.simulation.mirror.net.minecraft.entity.Targeter {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static int AI_DISABLED_FLAG;
    public static int ATTACKING_FLAG;
    ...
    public static boolean DEFAULT_CAN_PICK_UP_LOOT;
    public static float DEFAULT_FRICTION;
    public static boolean DEFAULT_LEFT_HANDED;
    public static int DEFAULT_MIN_FREEZE_DAMAGE_TICKS;
    public static boolean DEFAULT_NO_AI;
    public static boolean DEFAULT_PERSISTENCE_REQUIRED;
    public static int DEFAULT_PORTAL_COOLDOWN;
    public static java.util.List<murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentSlot> EQUIPMENT_INIT_ORDER;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3i ITEM_PICK_UP_RANGE_EXPANDER;
    public static int LEFT_HANDED_FLAG;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Byte> MOB_FLAGS;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.ai.control.BodyControl bodyControl;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentDropChances equipmentDropChances;
    ...
    public java.util.Optional<murat.simv2.simulation.mirror.net.minecraft.registry.RegistryKey<murat.simv2.simulation.mirror.net.minecraft.loot.LootTable>> lootTable;
    ...
    public java.util.Map<murat.simv2.simulation.mirror.net.minecraft.entity.ai.pathing.PathNodeType, java.lang.Float> pathfindingPenalties;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos positionTarget;
    public float positionTargetRange;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity target;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.mob.MobVisibilityCache visibilityCache;
    public boolean wasInPowderSnow;

    public MobEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.loot.context.LootWorldContext createEquipmentLootParameters(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0) {
        return null;
    }
    ...
    public void enchantEquipment(murat.simv2.simulation.mirror.net.minecraft.world.ServerWorldAccess p0, murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentSlot p1, murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random p2, float p3, murat.simv2.simulation.mirror.net.minecraft.world.LocalDifficulty p4) {
    }
    ...
    public double getAttributeValueWithStack(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry p1, murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentSlot p2) {
        return 0.0D;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.ActionResult interactWithItem(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.util.Hand p1) {
        return null;
    }
    ...
    public boolean prefersNewArmor(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentSlot p2) {
        return false;
    }
    ...
    public boolean prefersNewWeapon(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.entity.EquipmentSlot p2) {
        return false;
    }
