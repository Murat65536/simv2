...
public class RangedWeaponItem extends murat.simv2.simulation.mirror.net.minecraft.item.Item {
    ...
    public static java.util.function.Predicate<murat.simv2.simulation.mirror.net.minecraft.item.ItemStack> BOW_PROJECTILES;
    public static java.util.function.Predicate<murat.simv2.simulation.mirror.net.minecraft.item.ItemStack> CROSSBOW_HELD_PROJECTILES;
    ...
    public RangedWeaponItem(murat.simv2.simulation.mirror.net.minecraft.item.Item.Settings p0) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.projectile.ProjectileEntity createArrowEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p2, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p3, boolean p4) {
        return null;
    }
    ...
    public java.util.function.Predicate getHeldProjectiles() {
        return null;
    }

    public static murat.simv2.simulation.mirror.net.minecraft.item.ItemStack getHeldProjectile(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0, java.util.function.Predicate p1) {
        return null;
    }
    ...
    public java.util.function.Predicate getProjectiles() {
        return null;
    }

    public static murat.simv2.simulation.mirror.net.minecraft.item.ItemStack getProjectile(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p2, boolean p3) {
        return null;
    }
    ...
    public int getWeaponStackDamage(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
        return 0;
    }
    ...
    public static java.util.List load(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p2) {
        return null;
    }
    ...
    public void shootAll(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1, murat.simv2.simulation.mirror.net.minecraft.util.Hand p2, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p3, java.util.List p4, float p5, float p6, boolean p7, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p8) {
    }

    public void shoot(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0, murat.simv2.simulation.mirror.net.minecraft.entity.projectile.ProjectileEntity p1, int p2, float p3, float p4, float p5, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p6) {
    }
