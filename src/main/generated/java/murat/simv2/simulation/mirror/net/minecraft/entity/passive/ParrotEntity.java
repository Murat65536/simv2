...
public class ParrotEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.passive.TameableShoulderEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.Flutterer {
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos songSource;
    public float speed;
    ...
    public ParrotEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public boolean canAttackWithOwner(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1) {
        return false;
    }
    ...
    public boolean canTeleportOntoLeaves() {
        return false;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getRandomSound(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random p1) {
        return null;
    }
    ...
    public static float getSoundPitch(murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random p0) {
        return 0.0F;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getSound(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0) {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.passive.ParrotEntity.Variant getVariant() {
        return null;
    }
    ...
    public static boolean imitateNearbyMob(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.entity.Entity p1) {
        return false;
    }
    ...
    public boolean isOwner(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0) {
        return false;
    }
    ...
    public boolean mountOnto(murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity p0) {
        return false;
    }
    ...
    public void setInSittingPose(boolean p0) {
    }
    ...
    public void setOwner(murat.simv2.simulation.mirror.net.minecraft.entity.LazyEntityReference p0) {
    }
    ...
    public void setSitting(boolean p0) {
    }
    ...
    public void setTamedBy(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
    }

    public void setTamed(boolean p0, boolean p1) {
    }
    ...
    public void setVariant(murat.simv2.simulation.mirror.net.minecraft.entity.passive.ParrotEntity.Variant p0) {
    }
    ...
    public void showEmoteParticle(boolean p0) {
    }
    ...
    public void updateAttributesForTamed() {
    }
    ...
    public static class FlyOntoTreeGoal {
        ...
        public murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d getWanderTarget() {
            return null;
        }
        ...
        public murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d locateTree() {
            return null;
        }

        public void setChance(int p0) {
        }
    ...
    public static class Variant implements murat.simv2.simulation.mirror.net.minecraft.util.StringIdentifiable {
        ...
        public Variant(java.lang.String p0, int p1, int p2, java.lang.String p3) {
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.entity.passive.ParrotEntity.Variant byIndex(int p0) {
            return null;
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.entity.passive.ParrotEntity.Variant valueOf(java.lang.String p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.entity.passive.ParrotEntity.Variant[] values() {
            return null;
        }
