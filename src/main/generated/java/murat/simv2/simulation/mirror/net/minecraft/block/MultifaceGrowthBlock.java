...
public class MultifaceGrowthBlock extends murat.simv2.simulation.mirror.net.minecraft.block.MultifaceBlock {
    ...
    public MultifaceGrowthBlock(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
