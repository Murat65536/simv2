...
public class AbstractBoatEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.VehicleEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.Leashable {
    ...
    public boolean bubbleColumnIsDrag;
    public float bubbleWobble;
    public float bubbleWobbleStrength;
    ...
    public AbstractBoatEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, java.util.function.Supplier p2) {
    }
    ...
    public boolean checkBoatInWater() {
        return false;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location checkLocation() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location getUnderWaterLocation() {
        return null;
    }
    ...
    public void handleBubbleColumn() {
    }
    ...
    public static class Location {
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location IN_AIR;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location IN_WATER;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location ON_LAND;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location UNDER_FLOWING_WATER;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location UNDER_WATER;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location[] field_7715;

        public Location(java.lang.String p0, int p1) {
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location valueOf(java.lang.String p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.entity.vehicle.AbstractBoatEntity.Location[] values() {
            return null;
        }
