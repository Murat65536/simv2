...
public class GameRules {
    ...
    public static com.mojang.serialization.Codec createKeyCodec(java.lang.Class p0) {
        return null;
    }

    public boolean getBoolean(murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Key p0) {
        return false;
    }

    public int getInt(murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Key p0) {
        return 0;
    }

    public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type getRuleType(murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Key p0) {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Rule get(murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Key p0) {
        return null;
    }

    public void load(com.mojang.serialization.DynamicLike p0) {
    }

    public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Key register(java.lang.String p0, murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category p1, murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type p2) {
        return null;
    }
    ...
    public static class BooleanRule extends murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Rule {
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type create(boolean p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type create(boolean p0, java.util.function.BiConsumer p1) {
            return null;
        }

        public void deserialize(java.lang.String p0) {
        }
        ...
        public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.BooleanRule getThis() {
            return null;
        }
    ...
    public static class Category {
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category CHAT;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category DROPS;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category MISC;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category MOBS;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category PLAYER;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category SPAWNING;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category UPDATES;
        public java.lang.String category;
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category[] field_24102;

        public Category(java.lang.String p0, int p1, java.lang.String p2) {
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category valueOf(java.lang.String p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category[] values() {
            return null;
        }
    ...
    public static class IntRule extends murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Rule {
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type create(int p0) {
            return null;
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Type create(int p0, java.util.function.BiConsumer p1) {
            return null;
        }
        ...
        public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.IntRule getThis() {
            return null;
        }
        ...
        public static int parseInt(java.lang.String p0) {
            return 0;
        }
        ...
        public boolean validateAndSet(java.lang.String p0) {
            return false;
        }
    ...
    public static class Key<T> {
        ...
        public Key(java.lang.String p0, murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category p1) {
        }
        ...
        public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Category getCategory() {
            return null;
        }
    ...
    public static class Rule<T> {
        ...
        public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Rule getThis() {
            return null;
        }
    ...
    public static class Type<T> {
        ...
        public com.mojang.brigadier.builder.RequiredArgumentBuilder argument(java.lang.String p0) {
            return null;
        }

        public murat.simv2.simulation.mirror.net.minecraft.world.GameRules.Rule createRule() {
            return null;
        }
