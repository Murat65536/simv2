...
public class EnderDragonPart extends murat.simv2.simulation.mirror.net.minecraft.entity.Entity {
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.boss.dragon.EnderDragonEntity owner;
    public murat.simv2.simulation.mirror.net.minecraft.entity.EntityDimensions partDimensions;
    ...
    public EnderDragonPart(murat.simv2.simulation.mirror.net.minecraft.entity.boss.dragon.EnderDragonEntity p0, java.lang.String p1, float p2, float p3) {
    }
