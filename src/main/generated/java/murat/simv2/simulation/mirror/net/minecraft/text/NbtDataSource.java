...
public interface NbtDataSource {
    ...
    public static final com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.text.NbtDataSource> CODEC = null;

    public murat.simv2.simulation.mirror.net.minecraft.text.NbtDataSource.Type getType();

    public java.util.stream.Stream get(murat.simv2.simulation.mirror.net.minecraft.server.command.ServerCommandSource p0);
