...
public class VehicleEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.Entity {
    ...
    public VehicleEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
