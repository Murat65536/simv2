...
public class WolfEntity {
    ...
    public static float field_49237;
    public static int field_49791;
    public static int field_52002;
    public static float field_52477;
    ...
    public float lastBegAnimationProgress;
    ...
    public WolfEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public float getBegAnimationProgress(float p0) {
        return 0.0F;
    }
    ...
    public float getFurWetBrightnessMultiplier(float p0) {
        return 0.0F;
    }
    ...
    public float getShakeProgress(float p0) {
        return 0.0F;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry getSoundVariant() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.Identifier getTextureId() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry getVariant() {
        return null;
    }
    ...
    public void setBegging(boolean p0) {
    }
    ...
    public void setSoundVariant(murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry p0) {
    }
    ...
    public void setVariant(murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry p0) {
    }
    ...
    public boolean shouldArmorAbsorbDamage(murat.simv2.simulation.mirror.net.minecraft.entity.damage.DamageSource p0) {
        return false;
    }
    ...
    public void tryTame(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
    }
    ...
    public static class AvoidLlamaGoal<T> {
        ...
        public boolean isScaredOf(java.lang.Object p0) {
            return false;
        }
