...
public class ReentrantThreadExecutor<R> extends murat.simv2.simulation.mirror.net.minecraft.util.thread.ThreadExecutor {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static long field_52421;
    public int runningTasks;

    public ReentrantThreadExecutor(java.lang.String p0) {
    }
    ...
    public ReentrantThreadExecutor() {
    }
