...
public class CandleBlock {
    ...
    public static it.unimi.dsi.fastutil.ints.Int2ObjectMap CANDLES_TO_PARTICLE_OFFSETS;
    ...
    public static java.util.function.ToIntFunction STATE_TO_LUMINANCE;
    ...
    public static void extinguish(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.block.BlockState p1, java.lang.Object p2, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p3) {
    }
