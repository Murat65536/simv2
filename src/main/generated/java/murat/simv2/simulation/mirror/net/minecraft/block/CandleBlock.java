...
public class CandleBlock extends murat.simv2.simulation.mirror.net.minecraft.block.AbstractCandleBlock implements murat.simv2.simulation.mirror.net.minecraft.block.Waterloggable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static murat.simv2.simulation.mirror.net.minecraft.state.property.IntProperty CANDLES;
    public static it.unimi.dsi.fastutil.ints.Int2ObjectMap<java.util.List<murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d>> CANDLES_TO_PARTICLE_OFFSETS;
    public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.block.CandleBlock> CODEC;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape[] SHAPES_BY_CANDLES;
    ...
    public static java.util.function.ToIntFunction<murat.simv2.simulation.mirror.net.minecraft.block.BlockState> STATE_TO_LUMINANCE;
    ...
    public CandleBlock(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
    ...
    public static boolean canBeLit(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }
    ...
    public static void extinguish(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.block.BlockState p1, murat.simv2.simulation.mirror.net.minecraft.world.WorldAccess p2, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p3) {
    }
    ...
    public java.lang.Iterable getParticleOffsets(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return null;
    }
    ...
    public static boolean isLitCandle(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }

    public boolean isNotLit(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }
