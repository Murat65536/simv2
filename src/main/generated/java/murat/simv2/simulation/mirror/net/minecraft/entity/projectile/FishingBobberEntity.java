...
public class FishingBobberEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.projectile.ProjectileEntity {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Boolean> CAUGHT_FISH;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Integer> HOOK_ENTITY_ID;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.Entity hookedEntity;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State state;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random velocityRandom;
    public boolean verticalCollision;
    public int waitCountdown;
    public int waitTimeReductionTicks;
    public boolean wasInPowderSnow;

    public FishingBobberEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }

    public FishingBobberEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, int p2, int p3) {
    }

    public FishingBobberEntity(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, int p2, int p3) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.Entity getHookedEntity() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity getPlayerOwner() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType getPositionType(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType getPositionType(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1) {
        return null;
    }
    ...
    public boolean isOpenOrWaterAround(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
        return false;
    }
    ...
    public void onEntityHit(murat.simv2.simulation.mirror.net.minecraft.util.hit.EntityHitResult p0) {
    }
    ...
    public void pullHookedEntity(murat.simv2.simulation.mirror.net.minecraft.entity.Entity p0) {
    }
    ...
    public boolean removeIfInvalid(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
        return false;
    }
    ...
    public void setPlayerFishHook(murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity p0) {
    }
    ...
    public void tickFishingLogic(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
    }
    ...
    public void updateHookedEntityId(murat.simv2.simulation.mirror.net.minecraft.entity.Entity p0) {
    }
    ...
    public int use(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
        return 0;
    }
    ...
    public static class PositionType {
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType ABOVE_WATER;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType INSIDE_WATER;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType INVALID;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType[] field_23239;

        public PositionType(java.lang.String p0, int p1) {
        }
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType valueOf(java.lang.String p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.PositionType[] values() {
            return null;
        }
    ...
    public static class State {
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State BOBBING;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State FLYING;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State HOOKED_IN_ENTITY;
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State[] field_7181;
        ...
        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State valueOf(java.lang.String p0) {
            return null;
        }

        public static murat.simv2.simulation.mirror.net.minecraft.entity.projectile.FishingBobberEntity.State[] values() {
            return null;
        }
