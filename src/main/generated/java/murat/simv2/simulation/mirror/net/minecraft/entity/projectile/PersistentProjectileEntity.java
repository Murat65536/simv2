...
public class PersistentProjectileEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.projectile.ProjectileEntity {
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Boolean> IN_GROUND;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Byte> PIERCE_LEVEL;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Byte> PROJECTILE_FLAGS;
    ...
    public java.util.List<murat.simv2.simulation.mirror.net.minecraft.entity.Entity> piercingKilledEntities;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.hit.EntityHitResult getEntityCollision(murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p1) {
        return null;
    }
    ...
    public static class PickupPermission {
        ...
        public static com.mojang.serialization.Codec<murat.simv2.simulation.mirror.net.minecraft.entity.projectile.PersistentProjectileEntity.PickupPermission> CODEC;
