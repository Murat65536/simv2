...
public class WitherEntity {
    ...
    public static int DEFAULT_INVUL_TIMER;
    ...
    public float[] lastSideHeadPitches;
    public float[] lastSideHeadYaws;
    public double lastX;
    public double lastY;
    ...
    public WitherEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public static boolean canDestroy(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }
    ...
    public double getHeadY(int p0) {
        return 0.0D;
    }

    public double getHeadZ(int p0) {
        return 0.0D;
    }
    ...
    public float getNextAngle(float p0, float p1, float p2) {
        return 0.0F;
    }
    ...
    public int getTrackedEntityId(int p0) {
        return 0;
    }
    ...
    public boolean isAngryAt(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0, murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p1) {
        return false;
    }
    ...
    public void setInvulTimer(int p0) {
    }
    ...
    public void setTrackedEntityId(int p0, int p1) {
    }
    ...
    public void shootAt(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0, float p1) {
    }

    public void shootSkullAt(int p0, double p1, double p2, double p3, boolean p4) {
    }

    public void shootSkullAt(int p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1) {
    }
