package murat.simv2.simulation.mirror.net.minecraft.entity.projectile.thrown;
...
public class EnderPearlEntity {
    ...
    public long chunkTicketExpiryTicks;
    ...
    public EnderPearlEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }

    public EnderPearlEntity(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p2) {
    }
    ...
    public static boolean canTeleportEntityTo(murat.simv2.simulation.mirror.net.minecraft.entity.Entity p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
        return false;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.item.Item getDefaultItem() {
        return null;
    }
    ...
    public void playTeleportSound(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p1) {
    }
    ...
    public void setItem(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
    }
