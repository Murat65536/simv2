...
public class LightningEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.Entity {
    ...
    public murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity channeler;
    ...
    public static int field_30062;
    public static double field_33906;
    public static double field_33907;
    ...
    public java.util.Set<murat.simv2.simulation.mirror.net.minecraft.entity.Entity> struckEntities;
    ...
    public LightningEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public static java.util.Optional cleanOxidationAround(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1) {
        return null;
    }

    public static void cleanOxidationAround(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos.Mutable p2, int p3) {
    }

    public static void cleanOxidation(murat.simv2.simulation.mirror.net.minecraft.world.World p0, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p1) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos getAffectedBlockPos() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity getChanneler() {
        return null;
    }
    ...
    public java.util.stream.Stream getStruckEntities() {
        return null;
    }
    ...
    public void setChanneler(murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity p0) {
    }

    public void setComponent(murat.simv2.simulation.mirror.net.minecraft.component.ComponentType p0, java.lang.Object p1) {
    }

    public void setCosmetic(boolean p0) {
    }
