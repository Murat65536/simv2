...
public class EntityAttachments extends java.lang.Object {
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.EntityAttachments.Builder builder() {
        return null;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.EntityAttachments of(float p0, float p1) {
        return null;
    }

    public static murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d rotatePoint(murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p0, float p1) {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.entity.EntityAttachments scale(float p0, float p1, float p2) {
        return null;
    }
    ...
    public static class Builder extends java.lang.Object {
        ...
        public murat.simv2.simulation.mirror.net.minecraft.entity.EntityAttachments build(float p0, float p1) {
            return null;
        }
