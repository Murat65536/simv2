...
public class PathAwareEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.mob.MobEntity {
    ...
    public PathAwareEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
