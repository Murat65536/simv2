...
public class TrapdoorBlock extends murat.simv2.simulation.mirror.net.minecraft.block.HorizontalFacingBlock implements murat.simv2.simulation.mirror.net.minecraft.block.Waterloggable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static com.mojang.serialization.MapCodec<murat.simv2.simulation.mirror.net.minecraft.block.TrapdoorBlock> CODEC;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.state.property.EnumProperty<java.lang.Object> HALF;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.block.BlockSetType blockSetType;
    ...
    public static java.util.Map<murat.simv2.simulation.mirror.net.minecraft.util.math.Direction, murat.simv2.simulation.mirror.net.minecraft.util.shape.VoxelShape> shapeByDirection;
    ...
    public TrapdoorBlock(murat.simv2.simulation.mirror.net.minecraft.block.BlockSetType p0, murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p1) {
    }
    ...
    public void flip(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p2, murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p3) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.block.BlockSetType getBlockSetType() {
        return null;
    }
    ...
    public void playToggleSound(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1, murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p2, boolean p3) {
    }
