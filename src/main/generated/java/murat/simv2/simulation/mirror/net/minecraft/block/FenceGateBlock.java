...
public class FenceGateBlock {
    ...
    public static boolean canWallConnect(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Direction p1) {
        return false;
    }
    ...
    public boolean isWall(murat.simv2.simulation.mirror.net.minecraft.block.BlockState p0) {
        return false;
    }
