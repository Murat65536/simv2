...
public class AbstractHorseEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.passive.AnimalEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.JumpingMount, murat.simv2.simulation.mirror.net.minecraft.entity.Tameable {

    // BEGIN GENERATED MIRROR NESTED STUBS
    public static int ANGRY_FLAG;
    ...
    public static boolean DEFAULT_TAME;
    public static int DEFAULT_TEMPER;
    public static int EATING_FLAG;
    public static int EATING_GRASS_FLAG;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.data.TrackedData<java.lang.Byte> HORSE_FLAGS;
    public static java.lang.String ID_KEY;
    public static murat.simv2.simulation.mirror.net.minecraft.entity.ai.TargetPredicate.EntityPredicate IS_BRED_HORSE;
    ...
    public static float MAX_HEALTH_BONUS;
    public static float MAX_JUMP_STRENGTH_BONUS;
    public static float MAX_MOVEMENT_SPEED_BONUS;
    public static int MAX_RIDING_COOLDOWN;
    public static int MINIMUM_DROPPED_EXPERIENCE_PER_EQUIPMENT;
    public static float MIN_HEALTH_BONUS;
    public static float MIN_JUMP_STRENGTH_BONUS;
    public static float MIN_MOVEMENT_SPEED_BONUS;
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.ai.TargetPredicate PARENT_HORSE_PREDICATE;
    ...
    public static int field_30414;
    public static int field_30415;
    public static int field_35039;
    public static double field_42647;
    public static float field_42979;
    public static float field_42980;
    ...
    public float lastEatingAnimationProgress;
    public float lastEatingGrassAnimationProgress;
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.LazyEntityReference<murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity> ownerReference;
    public long pistonMovementTick;
    public boolean playExtraHorseSounds;
    ...
    public AbstractHorseEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public boolean areInventoriesDifferent(murat.simv2.simulation.mirror.net.minecraft.inventory.Inventory p0) {
        return false;
    }
    ...
    public boolean bondWithPlayer(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
        return false;
    }
    ...
    public static double calculateAttributeBaseValue(double p0, double p1, double p2, double p3, murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random p4) {
        return 0.0D;
    }
    ...
    public static murat.simv2.simulation.mirror.net.minecraft.entity.attribute.DefaultAttributeContainer.Builder createBaseHorseAttributes() {
        return null;
    }
    ...
    public void eat(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.util.Hand p1, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p2) {
    }
    ...
    public void equipHorseArmor(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getAmbientStandSound() {
        return null;
    }

    public float getAngryAnimationProgress(float p0) {
        return 0.0F;
    }

    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getAngrySound() {
        return null;
    }
    ...
    public static float getChildHealthBonus(java.util.function.IntUnaryOperator p0) {
        return 0.0F;
    }

    public static double getChildJumpStrengthBonus(java.util.function.DoubleSupplier p0) {
        return 0.0D;
    }

    public static double getChildMovementSpeedBonus(java.util.function.DoubleSupplier p0) {
        return 0.0D;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.Vec2f getControlledRotation(murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p0) {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.sound.SoundEvent getEatSound() {
        return null;
    }

    public float getEatingAnimationProgress(float p0) {
        return 0.0F;
    }

    public float getEatingGrassAnimationProgress(float p0) {
        return 0.0F;
    }
    ...
    public double getFollowLeashSpeed() {
        return 0.0D;
    }
    ...
    public boolean getHorseFlag(int p0) {
        return false;
    }
    ...
    public static int getInventorySize(int p0) {
        return 0;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.server.network.ServerPlayerEntity getLovingPlayer() {
        return null;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.LazyEntityReference getOwnerReference() {
        return null;
    }

    public murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity getOwner() {
        return null;
    }
    ...
    public float getPathfindingFavor(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
        return 0.0F;
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity getTopLevelOwner() {
        return null;
    }
    ...
    public void growUp(int p0) {
    }

    public void growUp(int p0, boolean p1) {
    }
    ...
    public void initAttributes(murat.simv2.simulation.mirror.net.minecraft.util.math.random.Random p0) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.ActionResult interactHorse(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1) {
        return null;
    }
    ...
    public boolean isBreedingItem(murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p0) {
        return false;
    }
    ...
    public boolean isWooden(murat.simv2.simulation.mirror.net.minecraft.sound.BlockSoundGroup p0) {
        return false;
    }
    ...
    public void jump(float p0, murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p1) {
    }
    ...
    public murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d locateSafeDismountingPos(murat.simv2.simulation.mirror.net.minecraft.util.math.Vec3d p0, murat.simv2.simulation.mirror.net.minecraft.entity.LivingEntity p1) {
        return null;
    }
    ...
    public void lovePlayer(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
    }
    ...
    public void playWalkSound(murat.simv2.simulation.mirror.net.minecraft.sound.BlockSoundGroup p0) {
    }
    ...
    public void putPlayerOnBack(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0) {
    }
    ...
    public boolean receiveFood(murat.simv2.simulation.mirror.net.minecraft.entity.player.PlayerEntity p0, murat.simv2.simulation.mirror.net.minecraft.item.ItemStack p1) {
        return false;
    }
    ...
    public void setAngry(boolean p0) {
    }
    ...
    public void setBred(boolean p0) {
    }

    public void setBreedingAge(int p0) {
    }
    ...
    public void setChildAttributes(murat.simv2.simulation.mirror.net.minecraft.entity.passive.PassiveEntity p0, murat.simv2.simulation.mirror.net.minecraft.entity.passive.AbstractHorseEntity p1) {
    }

    public void setChildAttribute(murat.simv2.simulation.mirror.net.minecraft.entity.passive.PassiveEntity p0, murat.simv2.simulation.mirror.net.minecraft.entity.passive.AbstractHorseEntity p1, murat.simv2.simulation.mirror.net.minecraft.registry.entry.RegistryEntry p2, double p3, double p4) {
    }
    ...
    public void setEatingGrass(boolean p0) {
    }
    ...
    public void setHorseFlag(int p0, boolean p1) {
    }

    public void setId(int p0) {
    }

    public void setInAir(boolean p0) {
    }
    ...
    public void setLoveTicks(int p0) {
    }
    ...
    public void spawnPlayerReactionParticles(boolean p0) {
    }
    ...
    public static int toGrowUpAge(int p0) {
        return 0;
    }
    ...
    public void walkToParent(murat.simv2.simulation.mirror.net.minecraft.server.world.ServerWorld p0) {
    }
