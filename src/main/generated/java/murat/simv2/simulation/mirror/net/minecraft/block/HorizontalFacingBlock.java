...
public class HorizontalFacingBlock extends murat.simv2.simulation.mirror.net.minecraft.block.Block {
    ...
    public HorizontalFacingBlock(murat.simv2.simulation.mirror.net.minecraft.block.AbstractBlock.Settings p0) {
    }
