...
public class TameableEntity extends murat.simv2.simulation.mirror.net.minecraft.entity.passive.AnimalEntity implements murat.simv2.simulation.mirror.net.minecraft.entity.Tameable {
    ...
    public static boolean DEFAULT_SITTING;
    ...
    public static int field_52003;
    public static int field_52004;
    public static int field_52005;
    ...
    public TameableEntity(murat.simv2.simulation.mirror.net.minecraft.entity.EntityType p0, murat.simv2.simulation.mirror.net.minecraft.world.World p1) {
    }
    ...
    public boolean canTeleportTo(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
        return false;
    }
    ...
    public void tryTeleportNear(murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos p0) {
    }

    public void tryTeleportToOwner() {
    }

    public boolean tryTeleportTo(int p0, int p1, int p2) {
        return false;
    }
    ...
    public static class TameableEscapeDangerGoal {
        public static int RANGE_Y;
        public boolean active;
        public murat.simv2.simulation.mirror.net.minecraft.entity.passive.TameableEntity field_52006;
        ...
        public TameableEscapeDangerGoal(murat.simv2.simulation.mirror.net.minecraft.entity.passive.TameableEntity p0, double p1) {
        }

        public TameableEscapeDangerGoal(murat.simv2.simulation.mirror.net.minecraft.entity.passive.TameableEntity p0, double p1, murat.simv2.simulation.mirror.net.minecraft.registry.tag.TagKey p2) {
        }
        ...
        public murat.simv2.simulation.mirror.net.minecraft.util.math.BlockPos locateClosestWater(murat.simv2.simulation.mirror.net.minecraft.world.BlockView p0, murat.simv2.simulation.mirror.net.minecraft.entity.Entity p1, int p2) {
            return null;
        }
        ...
        public TameableEscapeDangerGoal() {
        }
